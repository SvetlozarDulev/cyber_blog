...
from .views import ReportListView, ReportDetailView, ReportEditView, ReportDeleteView,ReportCreateView, CybersecurityNewsView
...
urlpatterns = [
    ...
    path('cyber-news/', CybersecurityNewsView.as_view(), name='cyber-news'),
]
